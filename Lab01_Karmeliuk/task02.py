...
if __name__ == '__main__':
    ...
    pow_slider = Slider(pow_axes, 'Степінь', 1, graphic_builder.DOTS_AMOUNT - 1,
    ...
    def update_points(val):
        ...
        graphic_builder.model = np.poly1d(ValueBuilder.build_polynom_model(pow_slider.val, graphic_builder.LEARN_DOTS_X,
        ...
        pow_slider.valmax = amount_dots - 1
        pow_slider.ax.set_xlim(1, amount_dots - 1)
        fig.canvas.draw_idle()
        if pow_slider.val > pow_slider.valmax:
            pow_slider.set_val(amount_dots - 1)
